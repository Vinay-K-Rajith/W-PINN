...
`FEM_Baseline/dcsnn_ex1.py`, `dcsnn_ex2.py` — reproduces their exact problems.
...
## 4. Gear (sharp-feature showcase) — `Gear_Interface/` (existing)
...
## 5. FEM comparison — `FEM_Baseline/` (concede openly; do NOT claim to beat FEM)
